...
const categories = [
  ...
  { name: 'Budget Planners',    slug: 'budget-planners',    icon: Wallet,         color: 'rgba(224,168,44,0.15)',  accent: '#C9A84C' },
  ...
  { name: 'ADHD Planners',      slug: 'adhd-planners',      icon: Brain,          color: 'rgba(224,168,44,0.1)',   accent: '#C9A84C' },
  ...
  { name: 'Savings Challenges', slug: 'savings-challenges', icon: PiggyBank,      color: 'rgba(224,168,44,0.12)',  accent: '#9E7A2A' },
