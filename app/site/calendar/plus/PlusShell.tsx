...
import {
  ...
  Link2, Wand2, BarChart3, CreditCard, Menu, X, Info, Loader2, BookOpen, CalendarHeart, LayoutTemplate,
} from 'lucide-react'
...
const NAV: { href: string; label: string; icon: typeof LayoutGrid; exact?: boolean }[] = [
  ...
  { href: '/calendar/plus/templates', label: 'Event Templates', icon: LayoutTemplate },
