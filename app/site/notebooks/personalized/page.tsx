...
export const metadata: Metadata = {
  ...
  description: 'Custom-made digital notebooks built to order. Choose your colourway, size, motif and templates — we design a hyperlinked notebook just for you. GoodNotes & Notability ready.',
